...
function createBuilderStemCard(st, cfg){
  ...
  // On mobile, show Edit Take button first, then Clean, then Create
  card.innerHTML = headerHTML + eqFilterHTML + volumeHTML + waveformHTML + dragButtonHTML + editTakeButtonHTML + cleanButtonHTML + genCreateButtonHTML + `\n        <div class="status-line hidden mt-2 text-sm text-white/80">Ready to create</div>\n      `
